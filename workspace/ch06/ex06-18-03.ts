...
(() => {
  ...
  const cityList: City[] = [{ value: "Seoul", selected: false }, { value: "busan" }, { value: "GwangJu", selected: true } /*{ value: 56789 }*/];

  const zipcodeList: Zipcode[] = [{ value: 12345, selected: false }, { value: 34567, selected: true }, { value: 56789 }];
